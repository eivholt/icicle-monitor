...
![](Article/img/cover1.png "Synthetic training images")
...
![](Article/img/IMG_8710.jpg "Downtown, photo: Avisa Nordland")
...
![](Article/img/20240413_215105_.jpg "Arduino Portenta H7")
...
![](Article/img/EILogo.svg "Edge Impulse")
...
![](Article/img/Blender_select_vertex.png "3D icicle models exported from Blender")
...
![](Article/img/semantic-editor.png "Semantics Schema Editor")
...
![](Article/img/omniverse-bb.png "Omniverse bounding box")
...
![](Article/img/output1.png "Produced images")
...
![](Article/img/random_color.png "Random background color")

![](Article/img/output2.png "Random background color")
...
![](Article/img/random_grayscale.png "Random background grayscale")
...
![](Article/img/random_texture.png "Random background texture")

![](Article/img/random_texture_viewport.png "Random background texture, camera perspective")

![](Article/img/output3.png "Random background texture")
...
![](Article/img/output5.png "Sun study")

![](Article/img/output4.png "Sun study")

![](Article/img/output6.png "Sun study")
...
![](Article/img/2000-images.png "2000 images")

6000 images:

![](Article/img/6000-images-120cycles.png "6000 images")

14000 images:

![](Article/img/14000-images-120cycles_no-opt.png "14000 images")

37000 images:

![](Article/img/26000-images-light-5000coco-120cycles_no-opt.png "26000 images")
...
![](Article/img/model-testing1.png "Model testing")
...
![](Article/img/EI-ext-enable.png "Edge Impulse extension")

Install Sun study extension in Isaac Sim to be able to vary light conditions while testing.

![](Article/img/Isaac-sunstudy.png "Sun study in Isaac Sim")

Paste API key found under Edge Impulse Studio> Dashboard> Keys> Add new API key:

![](Article/img/EI-ext-api-key.png "Edge Impulse extension API key")
...
![](Article/img/EI-webasm.png "Edge Impulse WebAssembly")
...
![](Article/img/Isaac-resolution.png "Isaac Sim viewport resolution")
...
![](Article/img/Isaac-sensor.png "Isaac Sim sensors")

![](Article/img/Isaac-EI-1.png "Isaac Sim model testing")

![](Article/img/Isaac-EI-2.png "Isaac Sim model testing")

![](Article/img/Isaac-EI-3.png "Isaac Sim model testing")
...
![](Article/img/OpenMV_deployment.png "Edge Impulse Studio Deployment OpenMV Firmware")
...
![](Article/img/OpenMV-testing.png "Testing model on device with OpenMV")
...
![](Article/img/EI-arduino-library.png "Deploy model as Arduino compatible library")
...
![](Article/img/EI-arduino-library-example.png "Arduino compatible library example sketch")
...
![](Article/img/ttn-map.png "The Things Network")
...
![](Article/img/ttn-app.png "The Things Stack application")

![](Article/img/ttn-device.png "The Things Stack device")
...
![](Article/img/arduino-lora.png "Arduino transmitting inference results over LoRaWAN")
...
![](Article/img/portenta_h7_power.png "Arduino Portenta H7 power specs")

![](Article/img/portenta_h7_pinout.png "Arduino Portenta H7 pin-out")

![](Article/img/otii-arc-portenta.png "Otii Arc hook-up")

![](Article/img/otii-icicle-profile.png "Otii Arc power profile")
...
![](Article/img/yr-sun.png "YR weather API")
...
![](Article/img/ttn-decoder.png "The Things Stack decoder")
...
![](Article/img/ttn-data.png "The Things Stack live data")
...
![](Article/img/marker.png "Markers to avoid false negatives")
...
![](Article/img/object-scale.png "Object scale")
...
![](Article/img/grouping.png "Icicle grouping")
...
![](Article/img/AULSSON_EBBA.png "AULSSON_EBBA")

![](Article/img/Martin-Cathrae.png "Martin Cathrae")
...
![](Article/img/grayscale1.png "Grayscale")
